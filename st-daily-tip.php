...
function show_daily_tip($atts){
	...
	return add_daily_tip($group,$date,$title,$yesterday);
}
function add_daily_tip($grp,$date,$title,$yesterday)
{
	...
	$today_tip = select_today_tip($group,$date,$title,$yesterday);	
...
function select_today_tip($group,$date,$title,$yesterday){
