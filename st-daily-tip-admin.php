			...
			<div class="meta-box-sortables">
				...
				<div id="toc" class="postbox">
					...
					<div class="inside">
						...
						<a href="http://sanskruti.net/wordpress-plugins/wordpress-plugins-st-daily-tip/"><?php _e('Donate','stdailytip')?></a>
						<p>Or you could:</p>
						<ul>
							...
							<li><?php _e('Blog about it &amp; link to the ','stdailytip')?><a href="http://sanskruti.net/wordpress-plugins/wordpress-plugins-st-daily-tip/"><?php _e('plugin page','stdailytip')?></a></li>				
						</ul>
					</div>
				</div>
				<div id="toc" class="postbox">
